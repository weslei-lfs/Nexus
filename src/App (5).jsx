...
function Dashboard({ user, displayName, onLogout }) {
  ...
  return (
    ...
    gridTemplateAreas:'"sb bc bc cat crt" "sb ga re ac crt" "sb ca fi inv crt" "sb ev hj ins po" "sb bg rs tg sc"'
  }}>

          {/* COL 1 */}
          <div style={{ width:180,flexShrink:0,display:"flex",flexDirection:"column",gap:8,overflowY:"auto",display:"flex",flexDirection:"column",gap:6,overflowY:"auto" ,gridArea:"sb"}}}}>
