  ...
  return (
    <div style={{ minHeight:"100vh",background:"#0d0d0d",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans','Segoe UI',sans-serif" }}>
      <div className="fade-in" style={{ background:"#161616",border:"1px solid #242424",borderRadius:20,padding:44,width:400,boxShadow:"0 0 100px rgba(229,57,53,0.12)" }}>
        ...
        <input style={inp} placeholder="Usuário" value={username} onChange={e=>setUsername(e.target.value)} onKeyDown={e=>e.key==="Enter"&&handle()}/>
...
function Dashboard({ user, onLogout }) {
  ...
  const [monthData,setMonthData]=useState(()=>loadMonth(user,now.getFullYear(),now.getMonth()));
  ...
  const [savingsGoal,setSavingsGoal]=useState(()=>{ try{return Number(localStorage.getItem(`nexus_${user}_goal`))||0;}catch{return 0;} });
  ...
  useEffect(()=>{ saveMonth(user,viewYear,viewMonth,monthData); },[monthData,viewYear,viewMonth,user]);
  useEffect(()=>{ saveGlobal(user,global); },[global,user]);
  useEffect(()=>{ setMonthData(loadMonth(user,viewYear,viewMonth)); },[viewYear,viewMonth,user]);
  useEffect(()=>{ localStorage.setItem(`nexus_${user}_goal`,String(savingsGoal)); },[savingsGoal,user]);
    ...
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div style={{ background:t.header,borderBottom:`1px solid ${t.border}`,padding:"0 18px",height:54,display:"flex",alignItems:"center",gap:10,flexShrink:0,position:"sticky",top:0,zIndex:200 }}>
        ...
        <div style={{ display:"flex",alignItems:"center",gap:8,background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:8,padding:"5px 10px" }}>
          ...
          <span style={{ fontSize:12,color:t.text,fontWeight:700 }}>{user}</span>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridTemplateRows:"auto auto auto auto auto",alignContent:"start" }}>
          ...
          {/* COL 1 */}
          <div style={{ gridColumn:"1",gridRow:"1/6",display:"flex",flexDirection:"column",gap:9 }}>
          ...
          <div style={{ gridColumn:"2/4", gridRow:"3", minHeight:0 }}>
            <FinancialCalendar
...
export default function App() {
  ...
  return (<><GlobalStyle/>{user?<Dashboard user={user} onLogout={handleLogout}/>:<LoginScreen onLogin={handleLogin}/>}</>);
}
