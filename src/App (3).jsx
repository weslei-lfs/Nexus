  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:8,gridTemplateColumns:"180px 1fr 1fr 1fr 210px",gridTemplateRows:"auto auto auto auto auto",alignItems:"stretch" }}>

          {/* COL 1 */}
          <div style={{ gridColumn:"1",gridRow:"1/6",display:"flex",flexDirection:"column",gap:6,overflowY:"hidden",minHeight:0 }}>
          ...
          <div style={{ ...card,gridColumn:"4",gridRow:"4" }}>
            ...
            {/* HOJE */}
          <div style={{ ...card,gridColumn:"3",gridRow:"4",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 }}>
          ...
          {/* POUPANÇA — col5 row4 */}
          <div style={{ background:t.yellow,gridColumn:"4",gridRow:"3",alignSelf:"start",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
          ...
          {/* INSIGHTS */}
          <div style={{ ...card,gridColumn:"5",gridRow:"4" }}>
            <InsightsCard
          ...
          {/* BUDGET PLANNER */}
          <div style={{ ...card,gridColumn:"2",gridRow:"5" }}>
          ...
          {/* RESUMO DO MÊS */}
          <div style={{ ...card,gridColumn:"3",gridRow:"5" }}>
          ...
          {/* TOP GASTOS */}
          <div style={{ ...card,gridColumn:"4",gridRow:"5" }}>
