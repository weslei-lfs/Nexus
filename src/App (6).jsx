...
const LOGO_B64 = "data:image/png;base64,";const THEME_FILTERS = {
  "Dark Red": "none",
...
// ─── RESIZE OVERLAY ──────────────────────────────────────────────────────────
function ResizeHandle({ id, onResize }) {
  const startResize = (e) => {
    ...
    const onMove = (e) => {
      ...
      const nw = Math.max(100, Math.round((startW + t.clientX - startX)/20)*20);
      const nh = Math.max(60,  Math.round((startH + t.clientY - startY)/20)*20);
  ...
  return (
    <div onMouseDown={startResize} onTouchStart={startResize} style={{
      ...
      cursor:"se-resize", borderRadius:"0 0 8px 0", zIndex:100,
    }}/>
  );
}

function ResizeOverlay({ editing, sizes, onResize }) {
  const areas = ["bc","cat","crt","ga","re","ac","fi","ca","inv","ev","hj","ins","bg","rs","tg","sc","po"];
  if (!editing) return null;
  return (
    <>
      {areas.map(id => {
        const el = typeof document !== "undefined" ? document.querySelector(`[data-rid="${id}"]`) : null;
        if (!el) return null;
        return (
          <div key={id} style={{
            position:"absolute",
            ...
            border:"2px dashed #e53935", borderRadius:10,
            pointerEvents:"none", boxSizing:"border-box", zIndex:99,
          }}>
            <div style={{position:"absolute",top:2,left:2,background:"#e53935",color:"#fff",fontSize:8,fontWeight:700,borderRadius:3,padding:"1px 4px",pointerEvents:"none"}}>{id}</div>
            <div style={{position:"absolute",bottom:0,right:0,pointerEvents:"all"}}>
              <ResizeHandle id={id} onResize={onResize}/>
            </div>
          </div>
        );
      })}
...
function Dashboard({ user, displayName, onLogout }) {
    ...
    (async()=>{
      try {
        ...
        if(g) {
          ...
          if(g.layoutSizes) setLayoutSizes(g.layoutSizes);
        }
  ...
  const handleResize=(id,w,h)=>setLayoutSizes(p=>({...p,[id]:{w,h}}));
  useEffect(()=>{
    Object.entries(layoutSizes).forEach(([id,{w,h}])=>{
      const el=document.querySelector(`[data-rid="${id}"]`);
      if(el){if(w)el.style.width=w+"px";if(h)el.style.height=h+"px";}
    });
  },[layoutSizes]);
  ...
  useEffect(()=>{
    ...
    (async()=>{ 
      ...
      if(!md){try{md=JSON.parse(localStorage.getItem(`nexus_month_${user}_${viewYear}_${viewMonth}`)||"null");}catch(e){}}
  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div style={{ background:t.header,borderBottom:`1px solid ${t.border}`,padding:"0 18px",height:54,display:"flex",alignItems:"center",gap:10,flexShrink:0,position:"sticky",top:0,zIndex:200 }}>
        ...
        <button onClick={()=>{ if(editingLayout){ updGlobal(p=>({...p,layoutSizes})); } setEditingLayout(e=>!e); }} style={{ ...Gb(editingLayout?t.green:t.accent),padding:"5px 12px",fontSize:11,fontWeight:700,lineHeight:1 }}>{editingLayout?"✅ Confirmar":"📐 Layout"}</button>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridTemplateRows:"auto auto auto auto auto",alignContent:"start" }}>
          ...
          <div style={{ ...card,gridColumn:"2/4",gridRow:"1" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }} data-rid="bc">
          ...
          <div style={{ ...card,gridColumn:"4",gridRow:"1" }}>
            <div style={{ fontWeight:700,fontSize:13,marginBottom:8 }} data-rid="cat">{tr.byCategory}</div>
            {expByCat.length===0
          ...
          <div style={{ ...card,gridColumn:"5",gridRow:"1/4" }}>
            <div style={{ fontWeight:700,fontSize:13,marginBottom:4 }} data-rid="crt">{tr.wallet}</div>
          ...
          <div style={{ ...card,gridColumn:"2/3",gridRow:"2" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }} data-rid="ga">
          ...
          <div style={{ ...card,gridColumn:"3/4",gridRow:"2" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }} data-rid="re">
          ...
          <div style={{ gridColumn:"2/4", gridRow:"3" }} data-rid="ca">
            <FinancialCalendar
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"2" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }} data-rid="ac">
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"3" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }} data-rid="fi">
          ...
          <div style={{ ...card,gridColumn:"2/4",gridRow:"4" }}>
            <div style={{ fontWeight:700,fontSize:13,marginBottom:8 }} data-rid="ev">{tr.annualEvolution} — {viewYear}</div>
          ...
          {/* INVESTIMENTOS LISTA */}
          <div style={{ ...card,gridColumn:"2/5",gridRow:"5" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }} data-rid="inv">
          ...
          {/* HOJE */}
          <div style={{ ...card,gridColumn:"4",gridRow:"4",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 }} data-rid="hj">
            <div style={{ fontWeight:700,fontSize:13 }}>📅 Hoje — {now.toLocaleDateString(global.language||"pt-BR",{weekday:"long",day:"numeric",month:"long"})}</div>
            <div style={{ display:"flex",flexDirection:"column",gap:5,flex:1 }}>
              <div style={{ display:"flex",justifyContent:"space-between",fontSize:11 }}><span style={{ color:t.textSub }}>{tr.todayExpenses}</span><span style={{ color:t.red,fontWeight:700 }}>-{fmt(expenses.filter(e=>e.date===now.toISOString().slice(0,10)).reduce((s,e)=>s+Number(e.value||0),0)*rate)}</span></div>
              <div style={{ display:"flex",justifyContent:"space-between",fontSize:11 }}><span style={{ color:t.textSub }}>{tr.todayIncomes}</span><span style={{ color:t.green,fontWeight:700 }}>+{fmt(incomes.filter(e=>e.date===now.toISOString().slice(0,10)).reduce((s,e)=>s+Number(e.value||0),0)*rate)}</span></div>
              <div style={{ display:"flex",justifyContent:"space-between",fontSize:11 }}><span style={{ color:t.textSub }}>Dias restantes</span><span style={{ color:t.yellow,fontWeight:700 }}>{new Date(now.getFullYear(),now.getMonth()+1,0).getDate()-now.getDate()} dias</span></div>
            </div>
          </div>

          {/* INSIGHTS */}
          <div style={{ ...card,gridColumn:"5",gridRow:"4/6",display:"flex",flexDirection:"column" }} data-rid="ins">
            <InsightsCard expenses={expenses} incomes={incomes} investments={investments} categories={categories} monthData={monthData} viewMonth={viewMonth} viewYear={viewYear} now={now} t={t} fmt={fmt} MONTH_NAMES={MONTH_NAMES} monthlyCache={monthlyCache} card={card} tr={tr}/>
          </div>

          {/* BUDGET PLANNER */}
          <div style={{ ...card,gridColumn:"2",gridRow:"5",display:"flex",flexDirection:"column" }} data-rid="bg">
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:5,overflowY:"auto",flex:1,minHeight:0 }}>
              {(categories||[]).slice(0,5).map(cat=>{
                ...
                return (<div key={cat.id}><div style={{display:"flex",justifyContent:"space-between",fontSize:10,marginBottom:2}}><span style={{color:t.text}}>{cat.icon} {cat.name}</span><span style={{color:pct>=100?t.red:t.accent,fontWeight:600}}>{fmt(spent)}</span></div><div style={{background:t.bgCard2,borderRadius:3,height:5,overflow:"hidden"}}><div style={{width:`${pct}%`,height:"100%",background:pct>=100?t.red:t.green,borderRadius:3}}/></div></div>);
              })}
            </div>
          </div>

          {/* RESUMO */}
          <div style={{ ...card,gridColumn:"3",gridRow:"5",display:"flex",flexDirection:"column" }} data-rid="rs">
            <div style={{ fontWeight:700,fontSize:13,marginBottom:8 }}>📊 Resumo do Mês</div>
            <div style={{ display:"flex",flexDirection:"column",gap:5 }}>
              {[{label:"Receitas",val:totalInc*rate,color:t.green,icon:"⬆️"},{label:"Gastos",val:totalExp*rate,color:t.red,icon:"⬇️"},{label:"Investido",val:totalInv*rate,color:t.accent,icon:"📈"},{label:"Poupança",val:totalSavings*rate,color:t.yellow,icon:"🏦"},{label:"Saldo",val:balance*rate,color:balance>=0?t.green:t.red,icon:"💰"}].map((item,i)=>(
          ...
          {/* TOP GASTOS */}
          <div style={{ ...card,gridColumn:"4",gridRow:"5",display:"flex",flexDirection:"column" }} data-rid="tg">
          ...
          {/* SCORE */}
          <div style={{ ...card,gridColumn:"5",gridRow:"5",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }} data-rid="sc">
            {(()=>{
  ...
  return (
    <div onClick={onClose} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.82)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(8px)" }}>
      <div className="fade-in" onClick={e=>e.stopPropagation()} style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:16,padding:26,width:420,maxHeight:"80vh",display:"flex",flexDirection:"column",boxShadow:`0 0 80px ${t.accentGlow}` }}>
        <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16 }} data-rid="po">
