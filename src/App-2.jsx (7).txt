...
async function dbSaveGlobal(u,d) { return supaPost("nexus_global",{username:u,data:d,updated_at:new Date().toISOString()},true); },true); },true); },true); }
...
async function dbSaveMonth(u,y,m,d) { return supaPost("nexus_months",{username:u,year:y,month:m,data:d,updated_at:new Date().toISOString()},true); },true); },true); },true); }
    ...
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridTemplateRows:"auto 1fr auto auto 1fr auto",minHeight:"calc(100vh - 56px)",alignContent:"start" }}>
          ...
          {/* DONUT CATEGORIAS */}
          <div style={{ ...card,gridColumn:"4",gridRow:"1",display:"flex",flexDirection:"column",overflow:"hidden",alignSelf:"start",maxHeight:200 }}>
            ...
            {expByCat.length===0
              ...
              : <div style={{ display:"flex",flexDirection:"column",gap:7,overflowY:"auto",maxHeight:150 }}>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"4",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 }}>
