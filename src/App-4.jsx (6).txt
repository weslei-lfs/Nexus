  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridAutoRows:"auto",alignItems:"start",alignContent:"start" }}>
          ...
          {/* GRÁFICO MENSAL */}
          <div style={{ ...card,gridColumn:"2/4",gridRow:"1",alignSelf:"start",display:"flex",flexDirection:"column" }}>
          ...
          {/* DONUT CATEGORIAS */}
          <div style={{ ...card,gridColumn:"4",gridRow:"1",alignSelf:"start",display:"flex",flexDirection:"column",overflow:"hidden",alignSelf:"start",maxHeight:160,height:160 }}>
          ...
          {/* CARTEIRA com total */}
          <div style={{ ...card,gridColumn:"5",gridRow:"1/4",alignSelf:"start" }}>
          ...
          <div style={{ ...card,gridColumn:"2/3",gridRow:"2",alignSelf:"start",display:"flex",flexDirection:"column" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"3/4",gridRow:"2",alignSelf:"start",display:"flex",flexDirection:"column" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"2",alignSelf:"start" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"3",alignSelf:"start" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* EVOLUÇÃO */}
          <div style={{ ...card,gridColumn:"2/4",gridRow:"4",alignSelf:"start" }}>
          ...
          {/* INVESTIMENTOS LISTA */}
          <div style={{ ...card,gridColumn:"2/5",gridRow:"5",alignSelf:"start" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }}>
          ...
          {/* POUPANÇA CARD */}
          <div style={{ background:t.yellow,gridColumn:"5",gridRow:"4",alignSelf:"start",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,alignSelf:"start",cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
            <div style={{ fontWeight:800,fontSize:13,color:"#000" }}>🏦 Poupança</div>
            <div style={{ fontSize:22,fontWeight:900,color:"#000" }}>{fmt(totalSavings)}</div>
            <div style={{ fontSize:10,color:"#00000088" }}>{(global.savings||[]).length} {tr.deposits}</div>
            <div style={{ fontSize:10,color:"#000",marginTop:4,background:"#00000015",borderRadius:6,padding:"4px 8px" }}>Toque para gerenciar</div>
          </div>

          {/* SURPRESA 5: resumo do dia */}
          <div style={{ ...card,gridColumn:"4/5",gridRow:"4",alignSelf:"start",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 }}>
          ...
          {/* BUDGET PLANNER */}
          <div style={{ ...card,gridColumn:"2/3",gridRow:"6",alignSelf:"start" }}>
          ...
          {/* RESUMO DO MÊS */}
          <div style={{ ...card,gridColumn:"3/4",gridRow:"6",alignSelf:"start" }}>
          ...
          {/* TOP GASTOS */}
          <div style={{ ...card,gridColumn:"4/5",gridRow:"6",alignSelf:"start" }}>
          ...
          {/* SCORE FINANCEIRO */}
          <div style={{ ...card,gridColumn:"5",gridRow:"6",alignSelf:"start" }}>
