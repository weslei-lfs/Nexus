    ...
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <DashboardLayout editing={editingLayout} layoutData={layoutData} onLayoutChange={(id,pos)=>setLayoutData(p=>({...p,[id]:pos}))}>
          ...
          <div data-rid="fi" style={{ ...card,gridColumn:"4/5",gridRow:"3" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* EVOLUÇÃO */}
          <div data-rid="ev" style={{ ...card,gridColumn:"1/4",gridRow:"4" }}>
          ...
          {/* INVESTIMENTOS LISTA */}
          <div data-rid="inv" style={{ ...card,gridColumn:"1/5",gridRow:"5" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }}>
