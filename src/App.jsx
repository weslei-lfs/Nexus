...
async function dbSaveUser(username, password, displayName) {
  return supaPost("nexus_users", { username, password, display_name: displayName });
}
...
async function dbSaveGlobal(username, data) {
  return supaPost("nexus_global", { username, data, updated_at: new Date().toISOString() }, true);
}
...
async function dbSaveMonth(username, year, month, data) {
  return supaPost("nexus_months", { username, year, month, data, updated_at: new Date().toISOString() }, true);
}
...
async function dbSaveMeta(username, data) {
  return supaPost("nexus_meta", { username, data }, true);
}
...
async function dbSaveSharedAsset(symbol, data) {
  return supaPost("nexus_shared_assets", { symbol, data }, true);
}
