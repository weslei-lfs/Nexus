    ...
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ position:"relative",width:"100%",height:"800px",overflow:"hidden" }}>
          ...
          {/* COL 1 */}
          <div style={{ position:"absolute",left:0,top:0,width:160,height:800,display:"flex",flexDirection:"column",gap:6,overflowY:"auto" }}>
          ...
          {/* GRÁFICO MENSAL */}
          <div style={{ ...card,position:"absolute",left:160,top:0,width:520,height:100,overflow:"hidden",display:"flex",flexDirection:"column" }}>
          ...
          {/* DONUT CATEGORIAS */}
          <div style={{ ...card,position:"absolute",left:680,top:0,width:280,height:200,overflow:"hidden",alignSelf:"start",display:"flex",flexDirection:"column",overflow:"hidden",alignSelf:"start",maxHeight:160,height:160 }}>
          ...
          {/* CARTEIRA com total */}
          <div style={{ ...card,position:"absolute",left:1060,top:0,width:220,height:340,overflow:"hidden",alignSelf:"start" }}>
          ...
          <div style={{ ...card,position:"absolute",left:160,top:100,width:260,height:240,overflow:"hidden",alignSelf:"start",display:"flex",flexDirection:"column" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,position:"absolute",left:420,top:100,width:260,height:240,overflow:"hidden",alignSelf:"start",display:"flex",flexDirection:"column" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,position:"absolute",left:160,top:340,width:520,height:260,overflow:"hidden" }}>
            <FinancialCalendar
          ...
          {/* AÇÕES */}
          <div style={{ ...card,position:"absolute",left:980,top:340,width:300,height:260,overflow:"hidden" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* FIIs */}
          <div style={{ ...card,position:"absolute",left:680,top:340,width:300,height:260,overflow:"hidden" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* EVOLUÇÃO */}
          <div style={{ ...card,position:"absolute",left:360,top:700,width:360,height:100,overflow:"hidden" }}>
          ...
          {/* INVESTIMENTOS LISTA */}
          <div style={{ ...card,position:"absolute",left:680,top:200,width:380,height:140,overflow:"hidden" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }}>
            ...
            {/* HOJE */}
          <div style={{ ...card,position:"absolute",left:980,top:600,width:140,height:100,overflow:"hidden",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 }}>
          ...
          {/* POUPANÇA — col5 row4 */}
          <div style={{ background:t.yellow,position:"absolute",left:960,top:100,width:100,height:100,overflow:"hidden",alignSelf:"start",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
          ...
          {/* INSIGHTS */}
          <div style={{ ...card,position:"absolute",left:840,top:600,width:140,height:200,overflow:"hidden" }}>
            <InsightsCard
          ...
          {/* BUDGET PLANNER */}
          <div style={{ ...card,position:"absolute",left:720,top:600,width:120,height:200,overflow:"hidden" }}>
          ...
          {/* RESUMO DO MÊS */}
          <div style={{ ...card,position:"absolute",left:360,top:600,width:360,height:100,overflow:"hidden" }}>
          ...
          {/* TOP GASTOS */}
          <div style={{ ...card,position:"absolute",left:980,top:700,width:120,height:100,overflow:"hidden" }}>
          ...
          {/* SCORE FINANCEIRO */}
          <div style={{ ...card,position:"absolute",left:960,top:0,width:100,height:100,overflow:"hidden" }}>
          ...
          {/* CÂMBIO CARD */}
          <div style={{ ...card,position:"absolute",left:1100,top:600,width:180,height:120,overflow:"hidden" }}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6 }}>
