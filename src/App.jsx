    ...
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridAutoRows:"auto",alignItems:"start",alignContent:"start" }}>
          ...
          {/* POUPANÇA — col5 row4 */}
          <div style={{ background:t.yellow,gridColumn:"5",gridRow:"4",alignSelf:"start",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
          ...
          {/* INSIGHTS — col5 row5 */}
          <div style={{ ...card,gridColumn:"5",gridRow:"5",alignSelf:"start" }}>
            <InsightsCard
