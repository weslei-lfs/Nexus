    ...
    gridTemplateAreas:(()=>{
      ...
      return ["1","2","3","4","5"].map(r=>
        '"'+["1","2","3","4","5"].map(c=>grid[r]?.[c]||".").join(" ")+'"'
          ...
          {/* GRÁFICO MENSAL */}
          <div style={{ ...card,...card,flex:2,minWidth:0,minHeight:90,overflow:"hidden",display:"flex",flexDirection:"column" ,gridArea:"bc"}}>
          ...
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden",overflow:"hidden",alignSelf:"start",display:"flex",flexDirection:"column" ,gridArea:"ga"}}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden",overflow:"hidden",alignSelf:"start",display:"flex",flexDirection:"column" ,gridArea:"re"}}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden" ,gridArea:"ca"}}>
            <FinancialCalendar
          ...
          {/* AÇÕES */}
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden" ,gridArea:"ac"}}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* FIIs */}
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden" ,gridArea:"fi"}}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          {/* EVOLUÇÃO */}
          <div style={{ ...card,...card,flex:1,minWidth:0,overflow:"hidden" ,gridArea:"ev"}}>
          ...
          {/* INVESTIMENTOS LISTA */}
          <div style={{ ...card,...card,flex:1,minWidth:0,display:"flex",flexDirection:"column",overflow:"hidden" ,gridArea:"inv"}}>
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }}>
            ...
            {/* HOJE */}
          <div style={{ ...card,...card,flex:1,minWidth:0,overflow:"hidden",borderLeft:`3px solid ${t.yellow}`,display:"flex",flexDirection:"column",gap:6 ,gridArea:"hj"}}>
          ...
          {/* POUPANÇA — col5 row4 */}
          <div style={{ background:t.yellow,...card,width:100,flexShrink:0,overflow:"hidden",alignSelf:"start",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
          ...
          {/* INSIGHTS */}
          <div style={{ ...card,...card,width:140,flexShrink:0,overflow:"hidden" ,gridArea:"ins"}}>
            <InsightsCard
          ...
          {/* BUDGET PLANNER */}
          <div style={{ ...card,...card,width:120,flexShrink:0,overflow:"hidden" ,gridArea:"bg"}}>
          ...
          {/* RESUMO DO MÊS */}
          <div style={{ ...card,...card,flex:1,minWidth:0,overflow:"hidden" ,gridArea:"rs"}}>
          ...
          {/* TOP GASTOS */}
          <div style={{ ...card,...card,width:120,flexShrink:0,overflow:"hidden" ,gridArea:"tg"}}>
          ...
          {/* SCORE FINANCEIRO */}
          <div style={{ ...card,...card,width:100,flexShrink:0,overflow:"hidden" ,gridArea:"sc"}}>
