...
const TRANSLATIONS = {
  "pt-BR": {
    balance:"Saldo do Mês", income:"Receitas", expense:"Gastos", invested:"Investido",
    savings:"Poupança", savingsRate:"Taxa de Economia", categories:"Categorias",
    wallet:"Carteira", totalInvested:"TOTAL INVESTIDO", noInvestments:"Sem investimentos",
    barChart:"Receitas vs Gastos", monthly:"Mensal", byCategory:"Por Categoria",
    noCategoryExpenses:"Nenhum gasto categorizado", calendar:"Calendário",
    stocks:"Ações B3", fiis:"FIIs", searchStock:"Buscar ação...", searchFii:"Buscar FII...",
    ...
    insightsTitle:"Insights do Mês", goals:"Metas", noGoals:"Nenhuma meta ainda. Defina uma meta!",
    addGoalValue:"+ Adicionar valor", liveExchange:"Câmbio Ao Vivo", update:"Atualizar",
    updatedAt:"Atualizado:", switchTo:"trocar →", positive:"▲ Positivo", negative:"▼ Negativo",
    launches:"lançamentos", positions:"posições", deposits:"depósitos",
    monthGoal:"Meta mensal", define:"Definir", newBtn:"+ Novo", newFem:"+ Nova",
    noExpenses:"Nenhum gasto neste mês", noIncomes:"Nenhuma receita neste mês",
  ...
  "en-US": {
    ...
    insightsTitle:"Monthly Insights", goals:"Goals", noGoals:"No goals yet. Set a financial goal!",
  ...
  "de-DE": {
    ...
    insightsTitle:"Monatseinblicke", goals:"Ziele", noGoals:"Noch keine Ziele. Setze ein Finanzziel!",
  ...
  "fr-FR": {
    ...
    insightsTitle:"Aperçus du mois", goals:"Objectifs", noGoals:"Aucun objectif. Définissez un objectif!",
  ...
  "es-ES": {
    balance:"Saldo Mensual", income:"Ingresos", expense:"Gastos", invested:"Invertido",
    ...
    insightsTitle:"Perspectivas del mes", goals:"Metas", noGoals:"Sin metas. Define una meta financiera!",
    addGoalValue:"+ Agregar valor", liveExchange:"Tipo de cambio", update:"Actualizar",
    updatedAt:"Actualizado:", switchTo:"cambiar →", positive:"▲ Positivo", negative:"▼ Negativo",
    ...
    expensesTitle:"Gastos", incomesTitle:"Ingresos", days:"días",
  },
  "it-IT": {
    ...
    insightsTitle:"Approfondimenti del mese", goals:"Obiettivi", noGoals:"Nessun obiettivo. Imposta un obiettivo!",
    addGoalValue:"+ Aggiungi valore", liveExchange:"Cambio in tempo reale", update:"Aggiorna",
    updatedAt:"Aggiornato:", switchTo:"cambia →", positive:"▲ Positivo", negative:"▼ Negativo",
  ...
  "pt-PT": {
    balance:"Saldo Mensal", income:"Receitas", expense:"Despesas", invested:"Investido",
    savings:"Poupança", savingsRate:"Taxa de poupança", categories:"Categorias",
    wallet:"Carteira", totalInvested:"TOTAL INVESTIDO", noInvestments:"Sem investimentos",
    barChart:"Receitas vs Despesas", monthly:"Mensal", byCategory:"Por categoria",
    ...
    insightsTitle:"Insights do mês", goals:"Metas", noGoals:"Sem metas. Define uma meta financeira!",
    addGoalValue:"+ Adicionar valor", liveExchange:"Câmbio ao vivo", update:"Atualizar",
    updatedAt:"Atualizado:", switchTo:"trocar →", positive:"▲ Positivo", negative:"▼ Negativo",
    launches:"lançamentos", positions:"posições", deposits:"depósitos",
    monthGoal:"Meta mensal", define:"Definir", newBtn:"+ Novo", newFem:"+ Nova",
          ...
          <div style={{ overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:6 }}>
            ...
            <div style={{ position:"sticky",bottom:0,paddingTop:10,background:t.bgCard }}>
              <button onClick={()=>{
                ...
                ✓ {TRANSLATIONS[pendingLang]?.confirm||"Confirm"}
              </button>
            </div>
          </div>
            {/* Confirm button */}
