...
// ─── NEXUS LOGO SVG (adapts to theme accent color) ────────────────────────────
function NexusLogo({ accent, size = 36 }) {
  return (
    <svg width={size} height={size * 0.72} viewBox="0 0 120 86" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* N shape in red/accent */}
      <polygon points="8,72 8,14 32,50 56,14 56,72" fill={accent} opacity="0.95"/>
      {/* right side N / arrow */}
      <polygon points="56,72 56,14 80,50 104,14 104,30 86,56 104,72" fill={accent} opacity="0.85"/>
      {/* upward arrow */}
      <polygon points="88,10 104,10 104,44 96,36 88,44" fill={accent}/>
      {/* line chart overlay in white/silver */}
      <circle cx="18" cy="66" r="4" fill="white" opacity="0.9"/>
      <circle cx="46" cy="38" r="4" fill="white" opacity="0.9"/>
      <circle cx="74" cy="52" r="4" fill="white" opacity="0.9"/>
      <polyline points="18,66 46,38 74,52" stroke="white" strokeWidth="2.5" fill="none" opacity="0.85"/>
    </svg>
  );
}
