...
const BASE_STOCKS = [
  // Financeiro
  { symbol:"ITUB4", name:"Itaú Unibanco",   price:34.18, sector:"Financeiro" },
  { symbol:"BBDC4", name:"Bradesco",          price:14.93, sector:"Financeiro" },
  { symbol:"BBAS3", name:"Banco do Brasil",   price:28.40, sector:"Financeiro" },
  { symbol:"SANB11",name:"Santander BR",      price:26.80, sector:"Financeiro" },
  { symbol:"B3SA3", name:"B3",                price:12.15, sector:"Financeiro" },
  { symbol:"IRBR3", name:"IRB Brasil RE",     price:39.50, sector:"Financeiro" },
  { symbol:"CIEL3", name:"Cielo",             price:6.20,  sector:"Financeiro" },
  // Energia / Petróleo
  { symbol:"PETR4", name:"Petrobras PN",      price:38.72, sector:"Energia" },
  { symbol:"PETR3", name:"Petrobras ON",      price:40.10, sector:"Energia" },
  { symbol:"CSAN3", name:"Cosan",             price:14.50, sector:"Energia" },
  { symbol:"UGPA3", name:"Ultrapar",          price:21.30, sector:"Energia" },
  { symbol:"EGIE3", name:"Engie Brasil",      price:42.80, sector:"Energia" },
  { symbol:"CPFE3", name:"CPFL Energia",      price:34.60, sector:"Energia" },
  { symbol:"ENEV3", name:"Eneva",             price:15.20, sector:"Energia" },
  { symbol:"SBSP3", name:"Sabesp",            price:74.20, sector:"Saneamento" },
  { symbol:"CSMG3", name:"Copasa",            price:20.40, sector:"Saneamento" },
  // Mineração / Siderurgia
  { symbol:"VALE3", name:"Vale",              price:61.45, sector:"Mineração" },
  { symbol:"CSNA3", name:"CSN",               price:12.80, sector:"Siderurgia" },
  { symbol:"GGBR4", name:"Gerdau PN",         price:18.50, sector:"Siderurgia" },
  { symbol:"USIM5", name:"Usiminas",          price:8.90,  sector:"Siderurgia" },
  { symbol:"CMIN3", name:"CSN Mineração",     price:4.80,  sector:"Mineração" },
  // Consumo / Varejo
  { symbol:"ABEV3", name:"Ambev",             price:11.87, sector:"Consumo" },
  { symbol:"LREN3", name:"Lojas Renner",       price:14.20, sector:"Varejo" },
  { symbol:"MGLU3", name:"Magazine Luiza",    price:8.45,  sector:"Varejo" },
  { symbol:"VIIA3", name:"Via Varejo",         price:2.10,  sector:"Varejo" },
  { symbol:"AMER3", name:"Americanas",         price:1.05,  sector:"Varejo" },
  { symbol:"PCAR3", name:"GPA",               price:7.20,  sector:"Varejo" },
  { symbol:"ASAI3", name:"Assaí",             price:12.40, sector:"Varejo" },
  { symbol:"CRFB3", name:"Carrefour BR",       price:9.80,  sector:"Varejo" },
  // Saúde
  { symbol:"RDOR3", name:"Rede D'Or",          price:32.50, sector:"Saúde" },
  { symbol:"HAPV3", name:"Hapvida",            price:4.80,  sector:"Saúde" },
  { symbol:"GNDI3", name:"Intermédica",        price:12.30, sector:"Saúde" },
  { symbol:"FLRY3", name:"Fleury",             price:15.60, sector:"Saúde" },
  { symbol:"RADL3", name:"Raia Drogasil",      price:26.80, sector:"Saúde" },
  { symbol:"HYPE3", name:"Hypera Pharma",      price:28.40, sector:"Saúde" },
  // Tecnologia / Telecom
  { symbol:"VIVT3", name:"Telefônica Vivo",   price:52.40, sector:"Telecom" },
  { symbol:"TIMS3", name:"TIM",               price:18.90, sector:"Telecom" },
  { symbol:"TOTS3", name:"TOTVS",             price:34.20, sector:"Tecnologia" },
  { symbol:"POSI3", name:"Positivo Tech",      price:7.80,  sector:"Tecnologia" },
  { symbol:"CASH3", name:"Méliuz",             price:2.40,  sector:"Tecnologia" },
  { symbol:"LWSA3", name:"Locaweb",            price:5.10,  sector:"Tecnologia" },
  // Indústria / Bens de Capital
  { symbol:"WEGE3", name:"WEG",               price:52.34, sector:"Indústria" },
  { symbol:"EMBR3", name:"Embraer",            price:42.60, sector:"Indústria" },
  { symbol:"RAIL3", name:"Rumo",              price:22.80, sector:"Logística" },
  { symbol:"ECOR3", name:"EcoRodovias",        price:8.40,  sector:"Logística" },
  { symbol:"GOLL4", name:"Gol Linhas Aéreas",  price:5.20,  sector:"Aviação" },
  { symbol:"AZUL4", name:"Azul",              price:8.90,  sector:"Aviação" },
  // Imóveis / Construção
  { symbol:"CYRE3", name:"Cyrela",             price:18.40, sector:"Construção" },
  { symbol:"MRVE3", name:"MRV",               price:8.20,  sector:"Construção" },
  { symbol:"EVEN3", name:"Even",              price:10.30, sector:"Construção" },
  { symbol:"DIRR3", name:"Direcional",         price:22.50, sector:"Construção" },
  { symbol:"SMTO3", name:"São Martinho",       price:28.60, sector:"Agro" },
  { symbol:"SLCE3", name:"SLC Agrícola",       price:21.40, sector:"Agro" },
  { symbol:"AGRO3", name:"BrasilAgro",         price:32.10, sector:"Agro" },
  // Serviços / Outros
  { symbol:"RENT3", name:"Localiza",          price:43.10, sector:"Serviços" },
  { symbol:"MOVI3", name:"Movida",            price:12.60, sector:"Serviços" },
  { symbol:"PRIO3", name:"PetroRio",          price:44.80, sector:"Petróleo" },
  { symbol:"RECV3", name:"PetroRecôncavo",    price:22.30, sector:"Petróleo" },
  { symbol:"EQTL3", name:"Equatorial",        price:38.90, sector:"Energia" },
  { symbol:"TAEE11",name:"Taesa",             price:32.40, sector:"Energia" },
  { symbol:"TRPL4", name:"Transmissão Paul.", price:22.10, sector:"Energia" },
];
...
const BASE_FIIS = [
  ...
  { symbol:"TGAR11", name:"TG Ativo Real",       price:112.60, type:"Corporativo", dy:9.8 },
  ...
  // Hospitalares / Educacional
  { symbol:"HCTR11", name:"Hectare CE",          price:86.40,  type:"Recebíveis", dy:14.2 },
  { symbol:"MCCI11", name:"Mauá Capital CRI",    price:94.20,  type:"Recebíveis", dy:12.4 },
];
    ...
    <div style={{ minHeight:"100vh",background:"#0d0d0d",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans','Segoe UI',sans-serif" }}>
      <div className="fade-in" style={{ background:"#161616",border:"1px solid #242424",borderRadius:20,padding:44,width:400,boxShadow:"0 0 100px rgba(229,57,53,0.12)" }}>
        <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:8,justifyContent:"center" }}>
          <div style={{ width:40,height:40,borderRadius:12,background:"#e53935",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:900,fontSize:20,color:"#fff",boxShadow:"0 0 24px rgba(229,57,53,0.5)" }}>N</div>
...
function Dashboard({ user, onLogout }) {
  ...
  const fetchMarket=useCallback(()=>{
    setLoadingMkt(true);
    setTimeout(()=>{ setStocks(genMarket(BASE_STOCKS)); setFiis(genMarket(BASE_FIIS)); setLoadingMkt(false); },500);
  },[]);
  ...
  const addInvest=()=>{ if(!form.name||!form.value)return; updGlobal(p=>({...p,investments:[...p.investments,{...form,id:Date.now()}]})); closeModal(); };
  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridTemplateRows:"auto auto auto auto",alignContent:"start" }}>
          ...
          <div style={{ ...card,gridColumn:"2/3",gridRow:"2/4" }}>
            ...
            {filteredExpenses.length===0
              ? <div style={{ color:t.textMuted,fontSize:12,textAlign:"center",padding:"28px 0" }}>{searchQuery?"Nenhum resultado":"Nenhum gasto neste mês"}</div>
          ...
          <div style={{ ...card,gridColumn:"3/4",gridRow:"2/4" }}>
            ...
            {filteredIncomes.length===0
              ? <div style={{ color:t.textMuted,fontSize:12,textAlign:"center",padding:"28px 0" }}>{searchQuery?"Nenhum resultado":"Nenhuma receita neste mês"}</div>
              : <div style={{ display:"flex",flexDirection:"column",maxHeight:260,overflowY:"auto" }}>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"2" }}>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:1,maxHeight:180,overflowY:"auto" }}>
              {stocks.filter(s=>!stockSearch||(s.symbol+s.name+s.sector).toLowerCase().includes(stockSearch.toLowerCase())).map(s=>{ const up=s.regularMarketChangePercent>=0; return (
                <div key={s.symbol} style={{ display:"grid",gridTemplateColumns:"48px 1fr 64px 46px",gap:4,padding:"5px 0",borderBottom:`1px solid ${t.border}33`,alignItems:"center" }}>
                  <div>
                    <div style={{ fontWeight:800,fontSize:11,color:t.text }}>{s.symbol}</div>
                    <div style={{ fontSize:8,color:t.accent,fontWeight:600 }}>{s.sector}</div>
                  </div>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"3" }}>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:1,maxHeight:165,overflowY:"auto" }}>
              {fiis.filter(s=>!fiiSearch||(s.symbol+s.name+s.type).toLowerCase().includes(fiiSearch.toLowerCase())).map(s=>{ const up=s.regularMarketChangePercent>=0; return (
                <div key={s.symbol} style={{ display:"grid",gridTemplateColumns:"52px 1fr 60px 40px",gap:4,padding:"5px 0",borderBottom:`1px solid ${t.border}33`,alignItems:"center" }}>
                  <div>
                    <div style={{ fontWeight:800,fontSize:11,color:t.text }}>{s.symbol}</div>
                    <div style={{ fontSize:8,color:up?t.green:t.red,fontWeight:600 }}>{up?"+":""}{s.regularMarketChangePercent.toFixed(2)}%</div>
                  </div>
                  <span style={{ fontSize:10,color:t.textSub,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap" }}>{s.type} · {s.name}</span>
                  <span style={{ fontSize:11,fontWeight:700,color:t.text }}>R${s.regularMarketPrice.toFixed(2)}</span>
                  <span style={{ fontSize:10,fontWeight:700,color:t.green,textAlign:"right" }}>{s.dy}%</span>
                </div>
              ); })}
            </div>
          </div>
