  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <DashboardLayout editing={editingLayout} layoutData={layoutData} onLayoutChange={(id,pos)=>setLayoutData(p=>({...p,[id]:pos}))}>
          ...
          <div style={{ ...card,gridColumn:"2/4",gridRow:"1" }}>
            <div data-rid="bc" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"4",gridRow:"1" }}>
            <div data-rid="cat" style={{ fontWeight:700,fontSize:13,marginBottom:8 }}>{tr.byCategory}</div>
            {expByCat.length===0
          ...
          <div style={{ ...card,gridColumn:"5",gridRow:"1/4" }}>
            <div data-rid="crt" style={{ fontWeight:700,fontSize:13,marginBottom:4 }}>{tr.wallet}</div>
          ...
          <div style={{ ...card,gridColumn:"2/3",gridRow:"2" }}>
            <div data-rid="ga" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"3/4",gridRow:"2" }}>
            <div data-rid="re" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div data-rid="ca" style={{ gridColumn:"2/4", gridRow:"3" }}>
            <FinancialCalendar
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"2" }}>
            <div data-rid="ac" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"4/5",gridRow:"3" }}>
            <div data-rid="fi" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8 }}>
          ...
          <div style={{ ...card,gridColumn:"1/4",gridRow:"4" }}>
            <div data-rid="ev" style={{ fontWeight:700,fontSize:13,marginBottom:8 }}>{tr.annualEvolution} — {viewYear}</div>
          ...
          <div style={{ ...card,gridColumn:"1/5",gridRow:"5" }}>
            <div data-rid="inv" style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:9 }}>
          ...
          <div data-rid="hj" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:6 }}>
          ...
          <div data-rid="ins" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column" }}>
          ...
          <div data-rid="bg" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column" }}>
          ...
          <div data-rid="rs" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column" }}>
          ...
          <div data-rid="tg" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column" }}>
          ...
          <div data-rid="sc" style={{ background:t.bgCard,border:`1px solid ${t.border}`,borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }}>
            {(()=>{const sav=totalInc>0?(totalInc-totalExp)/totalInc*100:0;const inv=totalInc>0?totalInv/totalInc*100:0;const sc=Math.min(100,Math.round(Math.max(0,sav)*0.5+inv*0.3+(expenses.length?20:0)));const col=sc>=70?t.green:sc>=40?t.yellow:t.red;return(<><div style={{fontWeight:700,fontSize:12,marginBottom:6}}>⭐ Score</div><div style={{fontSize:44,fontWeight:900,color:col,lineHeight:1}}>{sc}</div><div style={{fontSize:11,color:col,fontWeight:700,marginTop:4}}>{sc>=70?"Excelente!":sc>=40?"Bom":"Atenção"}</div><div style={{width:"100%",background:t.bgCard2,borderRadius:6,height:8,overflow:"hidden",marginTop:8}}><div style={{width:`${sc}%`,height:"100%",background:col,borderRadius:6}}/></div><div style={{fontSize:9,color:t.textMuted,textAlign:"center",marginTop:4}}>Eco:{sav.toFixed(0)}% Inv:{inv.toFixed(0)}%</div></>);})()}
          </div>
