...
export default function App() {
  ...
  const fetchMarket = useCallback(async()=>{
    setLoadingMkt(true);
    try {
      const TOKEN = "1gPHxuoP6T6aBWFbe2ryko";
      const [s,f] = await Promise.all([
        fetch(`https://brapi.dev/api/quote/PETR4,VALE3,ITUB4,BBDC4,ABEV3,WEGE3?fundamental=false&token=${TOKEN}`),
        fetch(`https://brapi.dev/api/quote/MXRF11,HGLG11,KNRI11,XPML11?fundamental=false&token=${TOKEN}`),
      ]);
