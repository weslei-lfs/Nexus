...
function Dashboard({ user, displayName, onLogout }) {
  ...
  useEffect(()=>{
    (async()=>{
      ...
      try {
        ...
        if(g) {
          setGlobalState({ categories:g.categories||DEFAULT_CATEGORIES, investments:g.investments||[], savings:g.savings||[], goals:g.goals||[], theme:g.theme||"Dark Red", currency:g.currency||"BRL" });
  ...
  const fmt=v=>{
    ...
    const locale = global.currency==="BRL" ? "pt-BR" : "en-US";
