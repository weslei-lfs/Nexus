  ...
  return (
    <div style={{ minHeight:"100vh",background:t.bg,color:t.text,fontFamily:"'DM Sans','Segoe UI',sans-serif",display:"flex",flexDirection:"column" }}>
      ...
      <div ref={scrollRef} style={{ flex:1,overflowY:"auto",padding:"14px 16px" }}>
        <div style={{ display:"grid",gap:10,gridTemplateColumns:"200px 1fr 1fr 1fr 210px",gridTemplateRows:"auto 1fr auto auto 1fr auto",minHeight:"calc(100vh - 56px)",alignContent:"start" }}>
          ...
          {/* GRÁFICO MENSAL */}
          <div style={{ ...card,gridColumn:"2/4",gridRow:"1",display:"flex",flexDirection:"column" }}>
          ...
          {/* DONUT CATEGORIAS */}
          <div style={{ ...card,gridColumn:"4",gridRow:"1",display:"flex",flexDirection:"column",overflow:"hidden",alignSelf:"start",maxHeight:160,height:160 }}>
          ...
          {/* POUPANÇA CARD */}
          <div style={{ background:t.yellow,gridColumn:"5",gridRow:"4",borderRadius:12,padding:"13px 15px",display:"flex",flexDirection:"column",gap:8,alignSelf:"start",cursor:"pointer" }} onClick={()=>setShowSavings(true)}>
